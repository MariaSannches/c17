var boy2,path,boy,cash,diamonds,jwellery,sword;
var gameOverImg, pathImg,boyImg,cashImg,diamondsImg,jwelleryImg,swordImg,boyImg2;
...
function preload(){
  ...
  boyImg2 = loadImage("Runner-2.png");
